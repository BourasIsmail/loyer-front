                ...
                <Tabs defaultValue="info" className="px-2">
                    ...
                    <div className="px-4 py-2 mx-auto lg:py-2">
                      <form onSubmit={handleSubmit}>
                        <div className="grid grid-cols-2 gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="dateEffetContrat">Date d'effet de contrat</Label>
                            <Input
                                id="dateEffetContrat"
                                type="date"
                                disabled={is_Observateur}
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="modeDePaiement">Mode de paiement</Label>
                            <Select
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="dateChangementBrute">Date de changement du brut</Label>
                            <Input
                              ...
                              >
                                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                  ...
                                  <span className="font-semibold">
                                    {selectedValue?.fileName || "Télécharger contrat"}
                                  </span>{" "}
                                    ou glisser-déposer
                                  </p>
                  ...
                  <TabsContent value="map">
                    <div className="container mx-auto p-4 space-y-4">
                      ...
                      <Button onClick={updateLocation}>Mettre à jour la carte</Button>
                      {error && (
